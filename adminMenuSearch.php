<?php
	...
	while($row = $db->fetch($query)) {
		...
		echo '<td><span class="icons"><a href="#" data-target="#editModal" data-toggle="modal"><img src="imgs/edit.png" onclick="showEditedItem('.$row['menu_id'].')"/></a><a href="#" data-target="#deleteModal" data-toggle="modal"><img src="imgs/delete.png" onclick="deleteMenuItem('."'".$row['menu_id']."'".', '."'".$row['menu_name']."'".')"/></a><a href="#" data-target="#viewModal" data-toggle="modal" onclick="view('.$row['menu_id'].')"><img src="imgs/view.png"/></a></span></td>';
		echo "</tr>";
	}
